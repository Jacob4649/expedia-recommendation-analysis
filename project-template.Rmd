...
- They all look pretty similar (*fig. 1*). There appears to be no relationship between
...
## Range For Probability of a Click
...
- In the real data, `r clicked_formatted`% of recommendations were clicked.
